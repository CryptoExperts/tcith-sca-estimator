...
plt.yscale("log")
plt.savefig("img/tcith-ggm-pc-"+str(N_min)+"-"+str(N)+".pdf", format="pdf", bbox_inches='tight')
plt.show()
#####################################################################
fig, ax = plt.subplots()
width = .6
...
plt.savefig("img/tcith-ggm-pc-"+str(target_N)+"-analysis.pdf", format="pdf", bbox_inches='tight')
plt.show()