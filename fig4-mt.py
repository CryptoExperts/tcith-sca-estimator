...
plt.yscale("log")
plt.savefig("img/tcith-mt-pc-"+str(N_min)+"-"+str(N)+".pdf", format="pdf", bbox_inches='tight')
plt.show()
...
ax.legend(loc="best")
plt.savefig("img/tcith-mt-pc-"+str(target_N)+"-analysis.pdf", format="pdf", bbox_inches='tight')
plt.show()